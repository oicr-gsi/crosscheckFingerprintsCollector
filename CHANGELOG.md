...
- the duplicate marking tasks was originall implemented with gatk/picard markduplicates.  this sits in another branch and was developed 2021-12, but never merged.  The task is now using sambamba which runs much faster
...
- removing the hg19 regression tests, as this will routinely run with hg38
